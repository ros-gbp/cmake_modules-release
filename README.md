## cmake_modules (noetic) - 0.5.2-1

The packages in the `cmake_modules` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic cmake_modules` on `Fri, 25 Apr 2025 23:31:20 -0000`
